...
volatile long tempRaw, lightRaw;
volatile long temp, light;
double temp2;
char result[100];
...
void main(void)
{
    ...
    while(1){
        ...
        if (i==0){
                ...
                //temp = (1/((1/298.15)+(1/3380)*log(1023/tempRaw)))-273.15;
                temp2 = log(1023/tempRaw);
                temp = (1/((1/298.15)+(1/3380)*temp2))-273.15;
...
void ConfigureAdc_temp(){
    ...
    ADC10CTL0 &= ~ENC;
    ADC10CTL1 = INCH_2 + ADC10DIV_0 + CONSEQ_2;
